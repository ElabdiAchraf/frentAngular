...
import {LoginActiveService} from "./service/filters/login-active-service.service";
import {AcountServiceServiceService} from "./service/filters/acount-service-service.service";
import {RouteActivteService} from "./service/filters/route-activte-service.service";
    ...
    imports: [
        RouterModule.forRoot(
            [
            {
                ...
                children: [
                    {path: '', component: DashboardComponent,canActivate: [RouteActivteService]},
                    {path: 'uikit/formlayout', component: FormLayoutComponent,canActivate: [RouteActivteService]},
                    {path: 'uikit/input', component: InputComponent,canActivate: [RouteActivteService]},
                    ...
                    {path: 'pages/empty', component: EmptyComponent,canActivate: [RouteActivteService]},
                    ...
                    {path: 'active', component: ActiveComponent,canActivate: [LoginActiveService,AcountServiceServiceService]},
                ]
            },
